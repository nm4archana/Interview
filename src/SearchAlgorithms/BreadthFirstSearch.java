...
public class BreadthFirstSearch {
	...
	// Constructor
	public BreadthFirstSearch(int noOfNodes, String initialState, String goal) {
	...
	// Initialize the queue(i.e Frontier)
	...
	private Node chooseNode(Queue<Node> frontier) {
	...
	public static void main(String[] args) {
		int noOfCities = 20;
		BreadthFirstSearch firstSearch = new BreadthFirstSearch(noOfCities, "Arad", "Eforie");
